...
class ArquivoProdutosDTO:
    def __init__(self, APId, APQtdeProdutos, APDataPostagem, APArquivo, APIdUsuario, APVersao, usuario=None, modelos=None, parametros_treinamentos=None, tratamentos_dados=None):
        self.APId = APId
